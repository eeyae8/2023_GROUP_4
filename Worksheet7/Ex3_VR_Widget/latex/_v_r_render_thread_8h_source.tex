...
\DoxyCodeLine{00036\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_v_r_render_thread}{VRRenderThread}}\ :\ \textcolor{keyword}{public}\ QThread\ \{}
...
\DoxyCodeLine{00046\ \ \ \ \ \}\ \mbox{\hyperlink{class_v_r_render_thread_a887ba74b8a5b02f927e4564049b85ffb}{Command}};}
\DoxyCodeLine{00047\ }
\DoxyCodeLine{00048\ }
...
\DoxyCodeLine{00068\ }
\DoxyCodeLine{00069\ }
\DoxyCodeLine{00070\ \ \ \ \ \textcolor{keywordtype}{void}\ addActorToVR(vtkActor*\ actor);}
\DoxyCodeLine{00071\ }
\DoxyCodeLine{00072\ }
\DoxyCodeLine{00073\ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00076\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_v_r_render_thread_af5bbbaf8625fc42278476a43bf018661}{run}}()\ \textcolor{keyword}{override};}
\DoxyCodeLine{00077\ }
\DoxyCodeLine{00078\ \textcolor{keyword}{private}:}
\DoxyCodeLine{00079\ \ \ \ \ \textcolor{comment}{/*\ Standard\ VTK\ VR\ Classes\ */}}
\DoxyCodeLine{00080\ \ \ \ \ vtkSmartPointer<vtkOpenVRRenderWindow>\ \ \ \ \ \ \ \ \ \ \ \ \ \ window;}
\DoxyCodeLine{00081\ \ \ \ \ vtkSmartPointer<vtkOpenVRRenderWindowInteractor>\ \ \ \ interactor;}
\DoxyCodeLine{00082\ \ \ \ \ vtkSmartPointer<vtkOpenVRRenderer>\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ renderer;}
\DoxyCodeLine{00083\ \ \ \ \ vtkSmartPointer<vtkOpenVRCamera>\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ camera;}
\DoxyCodeLine{00084\ }
\DoxyCodeLine{00085\ \ \ \ \ \textcolor{comment}{/*\ Use\ to\ synchronise\ passing\ of\ data\ to\ VR\ thread\ */}}
\DoxyCodeLine{00086\ \ \ \ \ QMutex\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ mutex;\ \ \ \ \ \ }
\DoxyCodeLine{00087\ \ \ \ \ QWaitCondition\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ condition;}
\DoxyCodeLine{00088\ }
\DoxyCodeLine{00090\ \ \ \ \ vtkSmartPointer<vtkActorCollection>\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ actors;}
\DoxyCodeLine{00091\ }
\DoxyCodeLine{00093\ \ \ \ \ std::chrono::time\_point<std::chrono::steady\_clock>\ \ t\_last;}
\DoxyCodeLine{00094\ }
\DoxyCodeLine{00098\ \ \ \ \ \textcolor{keywordtype}{bool}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ endRender;}
\DoxyCodeLine{00099\ }
\DoxyCodeLine{00100\ \ \ \ \ vtkSmartPointer<vtkActor>\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ actorToAdd;}
\DoxyCodeLine{00101\ }
\DoxyCodeLine{00102\ \ \ \ \ \textcolor{comment}{/*\ Some\ variables\ to\ indicate\ animation\ actions\ to\ apply.}}
\DoxyCodeLine{00103\ \textcolor{comment}{\ \ \ \ \ *}}
\DoxyCodeLine{00104\ \textcolor{comment}{\ \ \ \ \ */}}
\DoxyCodeLine{00105\ \ \ \ \ \textcolor{keywordtype}{double}\ rotateX;\ \ \ \ \ \ \ \ \ \textcolor{comment}{/*<\ Degrees\ to\ rotate\ around\ X\ axis\ (per\ time-\/step)\ */}}
\DoxyCodeLine{00106\ \ \ \ \ \textcolor{keywordtype}{double}\ rotateY;\ \ \ \ \ \ \ \ \ \textcolor{comment}{/*<\ Degrees\ to\ rotate\ around\ Y\ axis\ (per\ time-\/step)\ */}}
\DoxyCodeLine{00107\ \ \ \ \ \textcolor{keywordtype}{double}\ rotateZ;\ \ \ \ \ \ \ \ \ \textcolor{comment}{/*<\ Degrees\ to\ rotate\ around\ Z\ axis\ (per\ time-\/step)\ */}}
\DoxyCodeLine{00108\ \};}
\DoxyCodeLine{00109\ }
\DoxyCodeLine{00110\ }
\DoxyCodeLine{00111\ }
